...
This document details all commands supported by OpenGame, helping you efficiently manage sessions, customize the interface, and control its behavior.

OpenGame commands are triggered through specific prefixes and fall into three categories:

| Prefix Type                | Function Description                                | Typical Use Case                                                 |
| -------------------------- | --------------------------------------------------- | ---------------------------------------------------------------- |
| Slash Commands (`/`)       | Meta-level control of OpenGame itself               | Managing sessions, modifying settings, getting help              |
...
Slash commands are used to manage OpenGame sessions, interface, and basic behavior.
...
| `/bug`      | Submit issue about OpenGame                     | `/bug Button click unresponsive` |
| `/copy`     | Copy last output content to clipboard           | `/copy`                          |
| `/quit`     | Exit OpenGame immediately                       | `/quit` or `/exit`               |
...
Exclamation commands allow you to execute system commands directly within OpenGame.
